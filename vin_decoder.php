...
class Edmunds_vin_decorer {
    ...
    public function __construct($vin, $api_key = 'kte85guzd8qtkpcws9s9b8cx') { # The Edmunds API Key should be something like: dc8a9ffxmhcdbcdhv4h7d6fz
...
$my_car = new Edmunds_vin_decorer('1J4GS48KX5C640206');
