...
$vin = trim($_POST['vin']);
$edmunds_api_key = 'kte85guzd8qtkpcws9s9b8cx';
...
if(isset($_POST['vin'])){
$vin_url = 'https://api.edmunds.com/api/vehicle/v2/vins/'.$vin.'?fmt=json&api_key=kte85guzd8qtkpcws9s9b8cx'.$edmunds_api_key;
$vin_response = edmunds_api_req($vin_url);

$styles_id = $vin_response['years'][0]['styles'][0]['id'];
$style_details_url = 'https://api.edmunds.com/api/vehicle/v2/styles/'.$styles_id.'?view=full&fmt=json&api_key=kte85guzd8qtkpcws9s9b8cx'.$edmunds_api_key;
$style_details_response = edmunds_api_req($style_details_url);

$photos_url = 'https://api.edmunds.com/v1/api/vehiclephoto/service/findphotosbystyleid?styleId='.$styles_id.'&fmt=json&api_key=kte85guzd8qtkpcws9s9b8cx'.$edmunds_api_key;
...
$colors_url = 'https://api.edmunds.com/api/vehicle/v2/styles/'.$styles_id.'/colors?fmt=json&api_key=kte85guzd8qtkpcws9s9b8cx'.$edmunds_api_key;
...
$equipment_url = 'https://api.edmunds.com/api/vehicle/v2/styles/'.$styles_id.'/equipment?fmt=json&api_key=kte85guzd8qtkpcws9s9b8cx'.$edmunds_api_key;
